(() => {
  var e = {
      211: function (e, t) {
        !(function (e) {
          ...
          var le = { __spectrum: _, cssClasses: $, create: oe };
          (e.create = oe),
            (e.cssClasses = $),
            (e.default = le),
  ...
  (() => {
        ...
        : s ||
            (function (e) {
              ...
              if (
                ...
                return null;
              for (var s = _(e); v(s) && ["html", "body"].indexOf(C(s)) < 0; ) {
                var n = A(s);
                if (
                  "none" !== n.transform ||
                  "none" !== n.perspective ||
        ...
        if (C) {
          if (r) {
            var M,
              ...
              le = z + te - oe,
              ce = Se(f ? w(H, z + ee - oe - ae) : H, z, f ? y(F, le) : F);
            (C[x] = ce), (_[x] = ce - z);
          }
          if (o) {
            var de,
              ...
              xe = ve ? fe + T[he] + O[he] - be - L.altAxis : ge,
              Ee =
                f && ve
                  ? (function (e, t, s) {
                      var n = Se(e, t, s);
      ...
      var s,
        ...
        y = {
          ...
          show: function () {
            ...
            M(), j(), y.state.isMounted || (S.style.transition = "none");
            if (A()) {
              var r = k(),
                a = r.box,
                l = r.content;
    ...
    function bt(e, t) {
      ...
      document.addEventListener("touchstart", et, _e),
